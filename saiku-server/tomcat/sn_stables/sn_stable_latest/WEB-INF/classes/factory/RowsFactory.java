...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			if(linhaFinal.getNomeContaContabil() == null)
			{
				...
				else
				{
					...
					else
					{
						...
						linhaFinal.setNomeContaContabil("Total ~:"+(r.getNomeGrupo() == null || r.getNomeGrupo().equals("null") ? "DGA s/Desp.Financ.":r.getNomeGrupo()));
					}
				}
			}
		}
	...
	private boolean isOutrasDespFinanc(Row r)
	{
		...
		{
			if(r.getNomeContaContabil().contains(c))
				return true;
		}
	 ...
	 * 
	 */
	public Object buildTotal(ArrayList<Row> rows,boolean isCentroCusto) 
	{
		if(rows.size() >0)
		{
			Row sum = new Row();
