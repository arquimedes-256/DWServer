...
var Workspace = Backbone.View.extend({
    ...
    init_query: function(isNew) {
        ...
        if (this.selected_cube) {
            ...
            $(this.dimension_list.el).find('a[title="(All)"]').parent().remove();
            $(this.dimension_list.el).find('a[title^="(Tempo)"]').prev().addClass('dim_tempo');
            $(this.dimension_list.el).find('a[title^="(Embarcacao)"]').prev().addClass('dim_navio');
            $(this.dimension_list.el).find('a[title^="(Rebocador)"]').prev().addClass('dim_rebocador');
            $(this.dimension_list.el).find('a[title^="(Empresa)"]').prev().addClass('dim_empresa');
            $(this.dimension_list.el).find('a[title^="(Tabela)"]').prev().addClass('dim_tabela');
            $(this.dimension_list.el).find('a[title^="(Local)"]').prev().addClass('dim_local');
            $(this.dimension_list.el).find('a[title^="(Manobra)"]').prev().addClass('dim_manobra');
            $(this.dimension_list.el).find('a[title^="(Operacao)"]').prev().addClass('dim_operacao');
            ...
            $('a[title="Measures"]').prev().addClass('mensura');
        } else {
            // Someone literally selected "Select a cube"
            $(this.el).find('.dimension_tree').html('');
            $(this.el).find('.measure_tree').html('');
