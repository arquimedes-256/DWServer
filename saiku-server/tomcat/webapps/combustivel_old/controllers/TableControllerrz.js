function TableController()
{
	...
	{
		_addListeners();
		$('.logarSe').click(login);$('.salvarRegistros button').click(buildJson);
	};
	...
	function _setRowsFromMounth()
	{
		...
		for ( var i = 1; i < 32; i++) 
		{
			...
			var tr = 
				'<tr class="rowValue">'+
				'<td class="edit-mode false"><button class="btn btn-info">Liberar</button></td><td><input type="text" class="input-small inpt-data" placeholder="Data" id="'+(zeroFill(i)+"-"+zeroFill(idMes)+"-"+idAno)+'" value="'+(zeroFill(i)+"/"+zeroFill(idMes)+"/"+idAno)+'" disabled="true"></td>'+
			'<td class="control-group"><input type="text" class="input-mini inpt-saldo" disabled="true"></td>'+
	  		...
	  		'<td class="control-group"><input type="text" class="input-mini inpt-hmcp zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Horas MCP"></td>'+
	  		'<td class="control-group"><input type="text" class="input-mini inpt-hmca zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Horas MCA"></td>'+
...
Manutenção
         ...
         '</div></td>'+
	  	...
	  	'<td><input type="text" class="input-mini inpt-saldofinal zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Saldo Final" disabled="true"></td>'+
	  		'<td><input placeholder="0" type="text" class="input-mini inpt-aca zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Acidente com Afastamento"></td>'+
	  		'<td><input placeholder="0" type="text" class="input-mini inpt-asa zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Acidente sem Afastamento"></td>'+
	  		'<td><input placeholder="0" type="text" class="input-mini inpt-aa zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Acidente Ambiental"></td>'+
	  		'<td><input placeholder="0" type="text" class="input-mini inpt-am zz" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Acidente Material"></td>'
	...
	function emiteErrorDeCelula(input)
	{
		...
		TweenMax.to($('.item_fx'),1,{opacity:1});
	}
	function validaConsumo(input,fromAll)
	{
		...
		*/
		...
		if(((val > 0 && aux > 0) || (!val && !aux)) && !fromAll)
		{
			...
			existeError = false;
			dtaError = null;
			TweenMax.to($('.item_fx'),1,{opacity:0,onComplete:function()
			{
				$('.item_fx').hide();
			}});
		}
	...
	function buildJson()
	{
		...
		{
			$.ajax(urlSTR,
				{type:"POST",data:{json:jsonString},success:function(){
			...
			if(idFilial == 77 || (((dataDaLinha < dataAtual) || (dataDaLinha > dataAtual)) || parseInt(idMes) != _dataAtual.getMonth()+1 ))
			{
				...
				**/
					var exceptions = 	{
										...
										//'3':{dtInicio:new Date("2015-06-01"),dtFim:new Date("2015-06-31")},//STR
										//'4':{dtInicio:new Date("2015-06-01"),dtFim:new Date("2015-06-31")},
										'5':{dtInicio:new Date("2015-06-22"),dtFim:new Date("2015-06-23")},//PNG
										'6':{dtInicio:new Date("2015-06-23"),dtFim:new Date("2015-06-25")},//SDR
	...
	function _getFromCDATA(s)
	{
		...
		var v = s.match(/<!--\[CDATA\[(.+)\]\]-->/);return v ? v[1] : "";
	}
	...
	$(document).ready(function()
			{
				$('.item_fx').mouseenter(function()
				{
					...
					TweenMax.to(this,.3,{css:{backgroundColor:0xb40101,borderBottomColor:b,borderLeftColor:b,borderRightColor:b,borderTopColor:b}});
				});
				$('.item_fx').mouseleave(function()
				{
					var b = 0xCF0000;
					var bt = 0xD61616;
					TweenMax.to(this,1,{css:{backgroundColor:b,borderBottomColor:b,borderLeftColor:b,borderRightColor:b,borderTopColor:bt}});
				});
				$('.item_fx').click(function()
				{
					...
					{
						TweenMax.to(t,.3,{scale:1.1,onComplete:function()
						{
							TweenMax.to(t,.3,{scale:1,onComplete:function(){						
			...
			function scroller(id){
				...
				TweenLite.to(window, 2, {scrollTo:{y:scrollYPos-50, x:0}, ease:Power4.easeOut});
			}
			...
			{ 
				...
				if
				(
					checkIfFirstFithBusinessDay(dtAtual.getDate(),dtAtual.getMonth()+1,dtAtual.getYear()) 
					&& idMes < (dtAtual.getMonth()+1) && dtAtual.getHours() >= 11
				)
				{
