...
Manutenção
	  		 ...
	  		 */
				...
				'<li><a href="#Fora de Operacao">Fora de Operacao</a></li>' +
...
s
				...
				**/
					...
					var exceptions = {
						//'1':{dtInicio:new Date("2015-09-25"),dtFim:new Date("2015-09-26")},//VIT
						//'2':{dtInicio:new Date("2015-09-17"),dtFim:new Date("2015-09-21")},//rj1
						//'3':{dtInicio:new Date("2015-09-15"),dtFim:new Date("2015-09-18")},//STR
						//'4':{dtInicio:new Date("2015-09-04"),dtFim:new Date("2015-09-08")},
						//'5':{dtInicio:new Date("2015-10-05"),dtFim:new Date("2015-10-08")},//PNG
						//'6':{dtInicio:new Date("2015-09-22"),dtFim:new Date("2015-09-23")},//SDR
						//'7':{dtInicio:new Date("2015-09-04"),dtFim:new Date("2015-09-08")},//MAC
						//'8':{dtInicio:new Date("2015-09-23"),dtFim:new Date("2015-09-25")},//RGD
						//'9':{dtInicio:new Date("2015-09-17"),dtFim:new Date("2015-09-21")},//SEP
					};
		...
		if (idMes >= 11) {
			...
			//$('input[id="30-09-2015"]').parent().parent().find(allInput.replace(".inpt-saldo,","")+",.hrtype").removeAttr('disabled', '');
			//$('input[id="30-09-2015"]').parent().parent().find(allInput.replace(".inpt-saldo,","")+",.hrtype").removeAttr('disabled', '');
			//$('.salvarRegistros button').removeAttr('disabled');
			//ENDBLOCK
	...
	return {
		...
		throwTest : function() { throw ("Bla Bla Bla"); }
