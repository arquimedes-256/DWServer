...
public class Row 
{
	...
	private double vlrOrcadoNovo;
	
	public double getVlrOrcadoNovo() {
		return vlrOrcadoNovo;
	}
	public void setVlrOrcadoNovo(double vlrOrcadoNovo) {
		this.vlrOrcadoNovo = vlrOrcadoNovo;
	}
